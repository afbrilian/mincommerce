...
describe('BaseRepository - Generic CRUD Operations', () => {
  ...
  describe('Error Handling', () => {
    it('should handle database connection errors', async () => {
      ...
      await expect(testRepository.create(generateTestData.user())).rejects.toThrow(
    ...
    it('should handle invalid ID format', async () => {
      ...
      await expect(testRepository.findById(invalidId)).rejects.toThrow()
    })
  ...
  describe('Data Validation', () => {
    it('should handle empty data creation', async () => {
      await expect(testRepository.create({})).rejects.toThrow()
    })

    it('should handle null values', async () => {
      const testData = generateTestData.user({ email: null })

      await expect(testRepository.create(testData)).rejects.toThrow()
    })
  ...
  describe('Concurrent Operations', () => {
    it('should handle concurrent creates', async () => {
      const concurrentCreates = Array(5)
        .fill()
        .map((_, index) =>
          testRepository.create(
            generateTestData.user({
    ...
    it('should handle concurrent reads', async () => {
      ...
      const concurrentReads = Array(10)
        .fill()
        .map(() => testRepository.findById(created.user_id))
